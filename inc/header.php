<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php"><img src="bilder/about/nordic-choice-logo.png" style="height: 80px;" alt="logo"></a>
        ...
        <div class="modal-content">
            <form>
                ...
                <div class="modal-body">
                    ...
                    Merk: Dine opplysninger må samsvare med ID-en din (ID-kort, pass, førerkort, etc...) 
                    som kreves ved innsjekking.
                    </span>
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-6 ps-0 mb-3">
                                <label class="form-label">Tlf.nr</label>
                            ...
                            <div class="col-md-6 ps-0 mb-3">
                                <label class="form-label">Post kode</label>
                                <input type="number" class="form-control shadow-none">
                            </div>
                            ...
                            <div class="col-md-6 ps-0 mb-3">
                                ...
                                <input type="passord" class="form-control shadow-none">
                            </div>
